...
execute store result score quat_z int run data get storage math:io xyz[0] 10000

scoreboard players operation quat_x int = quat_z int
scoreboard players operation quat_y int = quat_w int
