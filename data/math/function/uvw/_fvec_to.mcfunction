...
execute store result score u int store result score v int run scoreboard players operation w int = fvec_x int
execute store result score sstemp_u1 int store result score sstemp_v1 int run scoreboard players operation sstemp_w1 int = fvec_y int
execute store result score sstemp_u2 int store result score sstemp_v2 int run scoreboard players operation sstemp_w2 int = fvec_z int
